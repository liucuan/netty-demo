 ...
 * 在结构上，ChannelHandlers解耦你的业务逻辑和网络代码。这会简化开发过程，因为代码会随着需求的变化而变化。 Created by jenny on 2017/3/13.
 */
...
public class JacksonServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRegistered(ChannelHandlerContext ctx) throws Exception {
        ...
        System.out.println(Thread.currentThread().getName() + " ServerHandler registered." + ctx.name());
    }
}
